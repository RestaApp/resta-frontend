...
- ~~`HANDOFF.md` TODO #1 (5 тумблеров prefs) и TODO #2 (фильтр `reviewed_id`) **уже реализованы** на backend — дока и FE-комментарии устарели.~~ ✅ `HANDOFF.md` синхронизирован (TODO #1/#2 зачёркнуты как сделанные); проверить остаточные FE-комментарии со ссылкой на эти TODO.
