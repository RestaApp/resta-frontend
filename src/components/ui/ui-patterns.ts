...
export const TAG_ACTIVE_CLASS = 'border-transparent gradient-primary text-white shadow-sm'
...
export const SEGMENTED_INDICATOR_CLASS = 'absolute bottom-1 top-1 rounded-full gradient-primary'
