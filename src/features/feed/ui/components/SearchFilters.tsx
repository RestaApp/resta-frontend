...
function SearchFiltersComponent({ activeFiltersList, onResetFilters }: SearchFiltersProps) {
  ...
  return (
    <div className="ui-density-page ui-density-py-sm bg-background border-b border-border">
      <div className="flex gap-2 items-center">
        ...
        <Button
          ...
          className="h-11 w-11 min-w-11 rounded-full p-0 shrink-0 text-muted-foreground hover:text-foreground"
        >
