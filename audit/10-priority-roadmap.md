...
**Фичи:** in-app `Notification`-записи для всех типов (*E*); детерминизм `application_for` (*E*); модерация отзывов или явное снятие статусов (*E*).
...
| P1 | ~18 | initData, БД-инварианты, N+1, in-app уведомления, модерация, контракт, FE error-handling, инфра-конфиг, тесты |
