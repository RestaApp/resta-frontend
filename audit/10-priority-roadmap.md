...
**Фичи:** in-app `Notification`-записи для всех типов (*E*); ~~авто-архивация `review_reminder` при создании отзыва — бэк (*C14*) + FE-инвалидация (*B10*)~~ ✅ сделано (ждёт мёрджа); детерминизм `application_for` (*E*); модерация отзывов или явное снятие статусов (*E*).
...
| P1 | ~19 (−1 ✅) | initData, БД-инварианты, N+1, in-app уведомления, ~~авто-закрытие review_reminder~~ ✅, модерация, контракт, FE error-handling, инфра-конфиг, тесты |
