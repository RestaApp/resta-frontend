...
export const Textarea = forwardRef<HTMLTextAreaElement, React.ComponentProps<'textarea'>>(
  ({ className, ...props }, ref) => (
    <textarea
      ...
      data-slot="textarea"
      className={cn(
        'flex min-h-25 w-full rounded-lg border bg-input-background px-4 py-3 text-base text-foreground caret-foreground transition-[background-color,border-color,box-shadow]',
