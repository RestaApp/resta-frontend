    ...
    <FormField label={label} htmlFor={inputId} error={error} className={className}>
      <div className="relative">
        <button
          ...
          className={cn(
            'relative flex min-h-10 w-full items-center rounded-lg border border-border/50 bg-input-background py-2.5 pl-4 pr-10 text-left text-base transition-[background-color,border-color,box-shadow]',
