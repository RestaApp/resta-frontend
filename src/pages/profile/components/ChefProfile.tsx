        ...
        <div className="bg-card rounded-2xl p-6 border border-border mb-4">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold mb-1">Иван Иванов</h2>
              <p className="text-muted-foreground text-sm">Повар</p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-muted-foreground">Опыт: 5 лет</span>
            </div>
          </div>
        </div>
